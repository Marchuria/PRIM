...
% 		data.d0_w(isnan(data.d0_w)) = nan;
        ...
        data.Kz_inst = data.Kz(:,:,49);

        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %% Saving output per orbit
		%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        
        name_file = ['PRIM_' ,num2str(year), num2str(month,'%0.2d'),num2str(day,'%0.2d'),'_', num2str(rev,'%0.2d'),'_JPLv5_IMERGv6B_short'];
...
%             'PRIM_Outputs/PSS',data.PSS,'PRIM_Outputs/Kz',data.Kz);
        ...
        hdf5write(outputfile,'SMAP_variables/time',data.time,...
            'SMAP_variables/lat',data.lat,'SMAP_variables/lon',data.lon,...
            'PRIM_Inputs/S_ref',data.S_ref,...
            'PRIM_Inputs/rain_rate_inst',data.rain_rate_inst,...            
            'PRIM_Outputs/PRIM_S0',data.PRIM_S0,'PRIM_Outputs/PRIM_S1m',data.PRIM_S1m,...
            'PRIM_Outputs/PRIM_S5m',data.PRIM_S5m, ...
            'PRIM_Outputs/PSS',data.PSS,'PRIM_Outputs/Kz_inst',data.Kz_inst);
...
%         h5writeatt(outputfile, '/PRIM_Outputs/Kz','Not calculated or invalid','-999');
        ...
        % Kz
        h5writeatt(outputfile, '/PRIM_Outputs/Kz_inst','units','m2/s');
        h5writeatt(outputfile, '/PRIM_Outputs/Kz_inst','long_name','Vertical Diffussivity Coefficient');
        h5writeatt(outputfile, '/PRIM_Outputs/Kz_inst','Not calculated or invalid','-999');
